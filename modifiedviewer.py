...
while True:
	...
	print(manualverts.shape)
	np.save("noClipping.npy",manualverts)
	#np.savetxt("notdone.txt",manualverts)
	#print(verts.shape)
    ...
    #STEPS FOR GETTING THE POINT CLOUD VIEW 
	
	#get verts2 and textcoordinates2 and color_source through socket connection
	#multiply by rotation matrix and add the translation vector 
	#use the pointcloud command twice 
