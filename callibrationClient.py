...
#We have to send a start time from the server before we can started collecting frames
startTime = time.time() + 5

client_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
client_socket.connect(("10.40.3.2", 8221))
#load center
#datanp = np.ones([3,3])
data = startTime
...
for frameNumber in range(0,20): 
    ...
    print("Time elapsed since start: ",time.time()-startTime)
